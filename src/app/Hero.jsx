...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center bg-[#f2f2f2] h-[90vh] gap-8 '>
      <div className='flex flex-col items-center justify-around gap-6 bg-[#f2f2f2] text-black p-5 overflow-hidden'>
